#myA=[
 #[1.231, -2.32, 233.232, -4.2],
 #[23.0, 23.2, -5.55, -1.221],
 #[2.2, 22.232, 3.21, -17.2],
 #[-32.0, 1.4, 2.8, -32.9]
#]
...
#myB = [
 ...
 #8.9,
 #2.1]
# это была старая версия числа строк матрицы, но я обновил её!
# теперь не нужно всё прописывать в коде, можно сразу в терминале =)

my_A_rows = int(input("введите число строк матрицы коэфициентов: "))
    
print("введите матрицу коэфициентов (пробелы между коэффициентами")
